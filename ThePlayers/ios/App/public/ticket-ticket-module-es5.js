(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ticket-ticket-module"], {
    ...
    /***/
    function SUL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function HJnd(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function qG1E(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_ticket_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./ticket.page.html */
      "6SUL");
      /* harmony import */


      var _ticket_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./ticket.page.scss */
      "05mq");
      /* harmony import */
      ...
      var TicketPage = /*#__PURE__*/function () {
        function TicketPage(http, router, env) {
        ...
        _createClass(TicketPage, [{
          ...
          value: function createTicket() {
            ...
            this.http.post("".concat(this.env.baseUri, "/tickets"), dataToPost).subscribe(function (resp) {
              _this.router.navigateByUrl("user-tickets");
            });
          }
        }, {
          key: "addAttachment",
          ...
          value: function removeAttachment(i) {
      ...
      TicketPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
        selector: "app-ticket",
