...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserTicketsPage", function() { return UserTicketsPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_user_tickets_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./user-tickets.page.html */ "/yHb");
/* harmony import */ var _user_tickets_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./user-tickets.page.scss */ "ma4t");
...
let UserTicketsPage = class UserTicketsPage {
    constructor(router, authService, http, env) {
        this.router = router;
        ...
        this.authService.getToken().then(() => {
            if (this.authService.isLoggedIn) {
                Storage.get({ key: "token" }).then((data) => {
                    let decodedToken = Object(jwt_decode__WEBPACK_IMPORTED_MODULE_9__["default"])(data.value);
    ...
    doRefresh(event) {
        this.authService.getToken().then(() => {
            if (this.authService.isLoggedIn) {
                Storage.get({ key: "token" }).then((data) => {
                    const decodedToken = Object(jwt_decode__WEBPACK_IMPORTED_MODULE_9__["default"])(data.value);
...
UserTicketsPage.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
    { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _env__WEBPACK_IMPORTED_MODULE_7__["GlobalEnv"] }
];
UserTicketsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserTicketsPageRoutingModule", function() { return UserTicketsPageRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _user_tickets_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./user-tickets.page */ "R94C");
...
let UserTicketsPageRoutingModule = class UserTicketsPageRoutingModule {
};
UserTicketsPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _user_tickets_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./user-tickets-routing.module */ "TP8x");
/* harmony import */ var _user_tickets_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./user-tickets.page */ "R94C");
...
let UserTicketsPageModule = class UserTicketsPageModule {
};
UserTicketsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"],
            _user_tickets_routing_module__WEBPACK_IMPORTED_MODULE_5__["UserTicketsPageRoutingModule"]
        ],
...
//# sourceMappingURL=user-tickets-user-tickets-module-es2015.js.map