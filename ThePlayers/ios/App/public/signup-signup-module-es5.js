(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["signup-signup-module"], {
    ...
    function yL7A(module, __webpack_exports__, __webpack_require__) {
      ...
      var _modal_registration_modal_registration_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../modal-registration/modal-registration.page */
      "U7wi");
      /* harmony import */
      ...
      var SignupPage = /*#__PURE__*/function () {
        function SignupPage(router, modalController, authService, http, env) {
        ...
        _createClass(SignupPage, [{
          ...
          value: function SignupForm() {
            ...
            this.authService.register(this.username, this.email, this.password).subscribe(function (data) {
              if (data && data["token"]) {
                Storage.set({
                  key: "token",
                  value: data["token"]
                }).then(function () {
                  _this.http.get("".concat(_this.env.baseUri, "/auth/email")).subscribe(function (data) {
                    Storage.remove({
                      key: "token"
                    });

                    _this.showCreateTeamModal();
                  }, function (error) {
                    window.alert("Errore sendEmail" + JSON.stringify(error.error.errors[0].msg));
                  });
                });
              }
            }, function (error) {
              window.alert("Errore in registrazione " + JSON.stringify(error.error.errors[0].msg));
            });
          }
        }, {
